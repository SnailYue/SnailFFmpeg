...
int VideoScreenshot::interrupt_cb(void *ctx) {
    int timeout = 3;
 ...
 * @return
 */
int VideoScreenshot::openInput(string inputUrl) {
...
shared_ptr<AVPacket> VideoScreenshot::readPacketFromSource() {
 ...
 * @return
 */
int VideoScreenshot::openOutput(string outUrl) {
 ...
 * 关闭输入
 */
void VideoScreenshot::closeInput() {
 ...
 * 关闭输出
 */
void VideoScreenshot::closeOutput() {
 ...
 * @return
 */
int VideoScreenshot::writePacket(shared_ptr<AVPacket> packet) {
 ...
 * @return
 */
int VideoScreenshot::initDecodeContext(AVStream *inputStream) {
 ...
 * @return
 */
int VideoScreenshot::initEncoderCodec(AVStream *inputStream, AVCodecContext **encodeContext) {
    AVCodec *picCodec;
    /**
     * 获取编码器
     */
 ...
 * @return
 */
bool VideoScreenshot::decode(AVStream *inputStream, AVPacket *packet, AVFrame *frame) {
    int gotFrame = 0;
    /**
     * 视频解码
     */
 ...
 * @return
 */
shared_ptr<AVPacket> VideoScreenshot::encode(AVCodecContext *encodeContext, AVFrame *frame) {
    int gotOutput = 0;
 ...
 * @return
 */
int VideoScreenshot::screenShot(string url, string output_name) {
    init();
