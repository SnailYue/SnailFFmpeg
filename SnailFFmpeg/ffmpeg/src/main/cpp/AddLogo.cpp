 ...
 * @return
 */
int AddLogo::interrupt_cb(void *context) {
    return 0;
}
 ...
 * @return
 */
int AddLogo::open_input(char *fileName, int inputIndex) {
    LOGI("open_input");
 ...
 * @return
 */
shared_ptr<AVPacket> AddLogo::read_packet_from_source(int inputIndex) {
 ...
 * @return
 */
int AddLogo::open_output(char *fileName, int inputIndex) {
    LOGI("open_output");
 ...
 * @param inputIndex
 */
void AddLogo::close_input(int inputIndex) {
    LOGI("close_input");
    if (context != nullptr) {
 ...
 * @return
 */
int AddLogo::init_encoder_codec(int width, int height, int inputIndex) {
 ...
 * @return
 */
int AddLogo::init_decode_codec(AVCodecID codecId, int inputIndex) {
 ...
 * @return
 */
bool AddLogo::decode_video(AVPacket *packet, AVFrame *frame, int inputIndex) {
    LOGI("decode_video");
    int gotFrame = 0;
 ...
 * @return
 */
int AddLogo::init_input_filter(AVFilterInOut *input, const char *filterName, int inputIndex) {
 ...
 * @return
 */
int AddLogo::init_output_filter(AVFilterInOut *output, const char *filterName) {
 ...
 * @return
 */
int AddLogo::add_logo(string videoUrl, string pictureUrl, string outputName) {
    LOGI("add_logo");
    string fileInput[2];
