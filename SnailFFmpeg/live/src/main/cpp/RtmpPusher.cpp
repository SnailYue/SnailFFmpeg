...
Java_com_snail_live_LivePusher_native_1init(JNIEnv *env, jobject thiz) {
    LOGI("native_init");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1start(JNIEnv *env, jobject thiz, jstring path) {
    LOGI("native_start");
    if (isStart) {
        return;
    }
...
Java_com_snail_live_LivePusher_getInputSamples(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1pushAudio(JNIEnv *env, jobject thiz,
                                                             jbyteArray data) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1pushVideo(JNIEnv *env, jobject thiz,
                                                             jbyteArray data) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1release(JNIEnv *env, jobject thiz) {
    LOGI("native_release");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1setAudioCodecInfo(JNIEnv *env, jobject thiz,
                                                                     jint sample_rate,
                                                                     jint channels) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1setVideoCodecInfo(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snail_live_LivePusher_native_1stop(JNIEnv *env, jobject thiz) {
    LOGI("native_stop");
    readyPushing = 0;
    packets.setWork(0);
    pthread_join(pid, 0);
